...
public class DishServiceImpl implements DishService {
    ...
    public void deleteBatch(List<Long> ids) {
        // when dish is on sale, can't delete
        for (Long id : ids) {
        ...
        // when dish is relate to combo meal, can't delete
